let usernames = ['maria', '4455alice', 'dinesh', 'adam', 'dog_guy', 'sabrina', 'terry', 'cat_lover', 'hamster-mom'];
...
// function linearSearchES6(arr, val) {
//     arr.forEach((item, i) => {if(val === arr[i]) return i;});
//     return -1;
// }
// console.log(linearSearch(states, 'Nebraska32'));
