        ...
        while (true) {
            ...
            if (rightChildIdx < length) {
                ...
                if (
                    ...
                    (swap && rightChild.priority > leftChild.priority)) swap = rightChildIdx;
            }
            if (swap === null) break;
...
queue.enqueue('common cold', 2);
queue.enqueue('gunshot wound', 10);
queue.enqueue('seizure', 3);
queue.enqueue('broken bone', 6);
queue.enqueue('headache', 1);
